...
public abstract class Person implements Serializable {
  ...
  public boolean equals(Object o) {
    if (this == o) {
      ...
      return this.surname.equals(person.surname) && this.name.equals(person.name) && Objects
          .equals(this.patronymic, person.patronymic) && this.password.equals(person.password);
    } else {
      return false;
    }
  }
